...
- [Delta-QA](https://delta-qa.com/en/) - Deterministic, no-code visual regression testing that flags only human-perceptible changes, without pixel thresholds. Runs in the cloud, and good news for local-first teams: it also comes as a desktop app you can run entirely on your own machine.
