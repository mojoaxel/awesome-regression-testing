...
- [Sherlo](https://sherlo.io) - Visual regression testing for React Native. Screenshots your app on iOS & Android simulators in the cloud and catches visual changes before release. Integrates with Storybook.
